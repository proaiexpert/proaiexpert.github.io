...
The current phase is repository sanitation / authority normalization after the approved Golden homepage was frozen.
...
- future micro-polish must start from current `main` after cleanup, never from an old donor or checkpoint.
