...
| **Local Repair Pro** | Website concept · Client-facing demonstration | Local-service architecture, Photo-to-Scope request preparation, regional content, and responsive intake design | [Case study](https://proai-expert.com/case-studies/local-repair-pro/) · [Live demo](https://proai-expert.com/handyman-vancouver-portland-demo/) · [GitHub](https://github.com/proaiexpert/handyman-vancouver-portland-demo) |
