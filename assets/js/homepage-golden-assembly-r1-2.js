/* ProAI Homepage Golden Assembly R1.2 — canonical clean-shell coordination only.
   Product copy and approved visual polish live in canonical HTML/CSS, not runtime overlays. */
(function () {
  'use strict';
