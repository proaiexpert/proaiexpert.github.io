...
The approved strategy is `docs/CLIENT_ACQUISITION_SOCIAL_AND_SALES_PLAN.md`.

The website redesign and commercial-content implementation are owned by a separate website workstream. This workspace owns sales execution, social selling, prospecting, qualification, proposals, closing, and the proof/referral loop.

## Completed

- Canonical client-acquisition operating plan approved and merged through PR #64.
- Social media and sales connected into one system.
...
- First independent review and case study.
- First two direct referral introductions.
...
- Do not redesign or edit the website in this workstream.
- Do not create another strategy master document.
- Do not automate outbound before manual scripts show evidence of positive response.
- Do not count social engagement as pipeline without a business, problem, decision-maker, and dated next action.
