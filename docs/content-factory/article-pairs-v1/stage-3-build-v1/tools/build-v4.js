...
function processArticle(r) {
  ...
  const legacyModuleMap = {
    ...
    'The Language Coverage Ladder': 'three-model',
    ...
    'После запуска нужна система управления контентом': 'governance-system',
    'Website governance and maintenance': 'governance-system',
    'Plan for maintenance and English-only boundaries': 'governance-system',
    ...
    'Реестр рисков предложения': 'proposal-risk-ledger',
    'Build a Proposal Risk Ledger': 'proposal-risk-ledger',
    ...
    'Карта прав и практического контроля': 'business-control-map',
    ...
    '10. Как сравнить несколько предложений': 'abc-comparison',
    'Сравнение предложений A/B/C': 'abc-comparison',
    'Compare normalized proposals': 'abc-comparison',
    'Явное резюме рисков': 'explicit-risk-summary',
    'Итоговая оценка риска': 'explicit-risk-summary',
    'Assign a risk label only after reviewing the Ledger': 'explicit-risk-summary',
    'Решение: Красный риск': 'red-risk-decision-gate',
    'Контрольная точка для красного пункта': 'red-risk-decision-gate',
    'Decision gate for a red item': 'red-risk-decision-gate',
    'Объяснение регулярных затрат': 'repeat-cost-explanation',
    'Repeat costs': 'repeat-cost-explanation',
    'Последовательность решения': 'ten-step-decision-sequence',
