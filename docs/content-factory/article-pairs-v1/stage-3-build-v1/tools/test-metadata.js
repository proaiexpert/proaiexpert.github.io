...
const records = ROUTES.map((route) => {
  ...
  const checks = {
    ...
    ogImage: attr($, 'meta[property="og:image"]') === `${route.lang === 'ru' ? 'https://proai-expert.com/assets/social/proai-home-og-ru-r1-1.png' : 'https://proai-expert.com/assets/social/proai-home-og-en-r1-1.png'}`,
    ...
    twitterImage: attr($, 'meta[name="twitter:image"]') === `${route.lang === 'ru' ? 'https://proai-expert.com/assets/social/proai-home-og-ru-r1-1.png' : 'https://proai-expert.com/assets/social/proai-home-og-en-r1-1.png'}`,
    jsonLdParsed: !jsonLd.parseError,
    jsonLdDates: jsonLd.datePublished === BUILD_DATE && jsonLd.dateModified === BUILD_DATE,
    jsonLdImage: jsonLd.image === `${route.lang === 'ru' ? 'https://proai-expert.com/assets/social/proai-home-og-ru-r1-1.png' : 'https://proai-expert.com/assets/social/proai-home-og-en-r1-1.png'}`,
