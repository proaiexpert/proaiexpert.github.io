...
### 0.4. Текущее состояние репозитория

- Ошибочный коммит остаётся в `portfolio-rebrand-v1`; по прямому указанию владельца ничего из него не удалялось и не откатывалось.
- `main` и production этим действием не изменялись.
- PR и публикация кейса не создавались.
- После ошибочного коммита в ветку был добавлен отдельный, не связанный с Алиной документ Financial Stream в коммите `b20be6c663d4bba0e7d8b95de18a6a3c547cda28`; его нельзя затрагивать при дальнейшем разборе.
- Настоящий V2-файл является только документацией и handoff для review.

### 0.5. Обязательное действие следующего исполнителя

Следующий исполнитель должен:

1. Полностью прочитать этот V2-документ.
2. Отдельно изучить diff коммита `d84a5f2c2c08da917645002310f6911faade6036`.
3. Сопоставить ошибочную реализацию с утверждённым направлением портфолио ProAI Expert и текущей архитектурой preview.
4. Подготовить владельцу понятную оценку: что было добавлено, что потенциально пригодно, что конфликтует с планом и какие последствия даст сохранение либо откат.
5. Не удалять, не исправлять, не переносить и не публиковать ничего до прямого решения владельца.

### 0.6. Решения, требующие подтверждения владельца

1. Оставить ошибочный коммит в ветке, полностью откатить его или использовать только отдельные элементы.
2. Допускать ли вообще отдельные EN/RU HTML-страницы кейса в выбранной архитектуре портфолио.
3. Оставлять ли изменения preview-архива и общий CSS или вернуть их к состоянию до `d84a5f2`.
4. Сохранять ли девять добавленных screenshot-assets и какие именно кадры разрешены для будущей публичной версии.
5. Утвердить визуальную подачу кейса относительно общей системы ProAI Expert до дальнейшей реализации.
6. Утвердить публичное использование формулировок о 18 маршрутах, четырёх статьях, 72 browser-проверках и отсутствии критических findings в рамках зафиксированного аудита.
7. Утвердить либо исключить публичную рыночную оценку стоимости проекта, приведённую в исходном case pack.
8. Определить отдельным решением момент создания PR, публикации или production-интеграции.
...
- Не удалять ошибочную реализацию автоматически.
- Не считать наличие HTML-кода утверждением дизайна.
- Не придумывать KPI, отзывы, лиды, конверсию, рост трафика или бизнес-результаты.
- Использовать только подтверждённые финальные production-материалы.
