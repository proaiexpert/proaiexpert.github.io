(function () {
  ...
  function loadWorkflowEnvironment() {
    ...
    script.src = 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/38b92195a11709546db8fe0beeaa782244eee83f/assets/js/homepage-workflow-environment-v1.js?v=20260803.5';
    script.async = false;
  ...
  function loadHeroCubeR1() {
    ...
    var script = document.createElement('script');
    script.src = 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/38b92195a11709546db8fe0beeaa782244eee83f/assets/js/proai-hero-cube-r1/bootstrap.js?v=20260813.1';
    script.async = true;
