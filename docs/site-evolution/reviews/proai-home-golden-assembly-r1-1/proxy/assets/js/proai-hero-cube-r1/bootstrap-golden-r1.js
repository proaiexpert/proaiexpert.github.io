...
(async function proaiHeroCubeGoldenR1() {
  ...
  if (!document.querySelector('script[data-proai-three-importmap]')) {
    ...
    map.textContent = JSON.stringify({ imports: {
      three: 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/38b92195a11709546db8fe0beeaa782244eee83f/assets/vendor/three-r180/build/three.module.min.js',
      'three/addons/': 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/38b92195a11709546db8fe0beeaa782244eee83f/assets/vendor/three-r180/examples/jsm/'
    }});
  ...
  try {
    await import('https://raw.githack.com/proaiexpert/proaiexpert.github.io/38b92195a11709546db8fe0beeaa782244eee83f/assets/js/proai-hero-cube-r1/source-final-motion-r2-touch-auto-45-r1.js?v=golden-r1');
