...
(async function proaiHeroCubeGoldenR1() {
  ...
  if (!document.querySelector('script[data-proai-three-importmap]')) {
    ...
    map.textContent = JSON.stringify({ imports: {
      three: 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/a8fba586122c5949a009965179b692d2aff6ec5d/assets/vendor/three-r180/build/three.module.min.js',
      'three/addons/': 'https://raw.githack.com/proaiexpert/proaiexpert.github.io/a8fba586122c5949a009965179b692d2aff6ec5d/assets/vendor/three-r180/examples/jsm/'
    }});
  ...
  try {
    await import('https://raw.githack.com/proaiexpert/proaiexpert.github.io/a8fba586122c5949a009965179b692d2aff6ec5d/assets/js/proai-hero-cube-r1/source-final-motion-r2-touch-auto-45-r1.js?v=golden-r1');
