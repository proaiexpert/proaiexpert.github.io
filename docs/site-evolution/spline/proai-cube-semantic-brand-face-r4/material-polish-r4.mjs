...
console.log(JSON.stringify({material:'MeshPhysicalMaterial / R4.3 persistent physical micro-engraving',engravedFace:'+Z',surfaceMaxOpacity:0,persistentInscription:true,alphaDominantReveal:false,microNormalEngraving:true,opticalDriver:SEMANTIC_R4_3_ENGRAVING.driver,seamAwareOcclusion:true,emissive:false,glowHalo:false,scanWipeShimmer:false,letterWordStagger:false,semanticVelocityMultiplier:1,semanticAcceleration:false,semanticDeceleration:false,semanticOrientationForcing:false,semanticMotionCoupled:false,effectiveGlobalMotionScale:1,timing:{triggerSearchStartMs:3200,triggerSearchEndMs:4200,opportunityEnvelopeMs:2370},motionChangedBySemantic:false},null,2));
