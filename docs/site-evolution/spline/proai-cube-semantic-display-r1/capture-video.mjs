...
const semanticEvents=(LANG==='en'?[['AI EXPERT',2],['TRUST',16.6],['INQUIRY',22.3],['RESPONSE',28.9],['RESULT',36.2]]:[['ДОВЕРИЕ',1],['ОБРАЩЕНИЕ',8],['РЕЗУЛЬТАТ',15]]).map(([word,start])=>({word,start,started:false}));
