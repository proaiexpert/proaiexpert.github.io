...
- Endpoint error **0 rad**; telemetry {"sampleCount":30,"monotonic":true,"overshoot":false,"maxAbsStepRad":0.8146612757144387,"firstStepRad":0.00047338383326915644,"lastStepRad":0.2315542194968203}.
...
- Review video 10.63 s at 24 fps (255 unique rendered frames, 859370 bytes); fixed-frame slice rendering plus real pointer-drag OrbitControls segment; no wall-clock retiming.
